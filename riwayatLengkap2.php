            ...
            <div class="container px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item"><a class="nav-link" href="#about">Riwayat</a></li>
        ...
        <section id="about">
            <div class="container px-4">
                <div class="row gx-4 justify-content-center">
                    ...
                    <?php
                        if($_GET['patokanRiwayat']=="a".$_SESSION['karyawan']){
                            ?>
                        <div class="row mt-3 mb-4">
                            <div class="col">
                                <a class="btn btn-warning" href="riwayatLengkap2.php?patokanRiwayat=a<?= $_SESSION['karyawan'] ?>">Semua</a>
                                &nbsp;
                            ...
                            $queryTampilAbsen = mysqli_fetch_all(
                                mysqli_query(
                                    $con,"SELECT a.*, b.nama, b.foto FROM absensi a
                                    JOIN karyawan b ON a.idKaryawan=b.idKaryawan
                                    WHERE a.idKaryawan = $idKaryawan AND a.tanggal ORDER BY a.tanggal DESC"
                                    ),MYSQLI_ASSOC
                                );
                        ...
                        $numero++;
                            ...
                            <div class="row mt-3 mb-4">
                                <div class="col">
                                    ...
                                    &nbsp;
                                    <a class="btn btn-danger" href="riwayatLengkap2.php?patokanRiwayat=b<?= $_SESSION['karyawan'] ?>">Bulan Ini</a>
                                </div>
                            </div>
                                <?php
                            $presentTgl = 
                            $queryTampilAbsen = mysqli_fetch_all(
                                mysqli_query(
                                    $con,"SELECT a.*, b.nama, b.foto FROM absensi a
                                    JOIN karyawan b ON a.idKaryawan=b.idKaryawan
                                    WHERE a.idKaryawan = $idKaryawan AND a.tanggal LIKE '%$monthDb"."___' ORDER BY a.tanggal DESC"
                                    ),MYSQLI_ASSOC
                                );
