...
JOIN divisi c ON a.idDivisi=c.idDivisi WHERE c.namaDivisi='$namaD' ORDER BY b.tanggal DESC");
$no = 1;
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center" style="font-weight:bold"><?= ($x['masuk'] !== NULL )? $x['masuk'] : "<span class='text-warning'>-</span>" ?>
                                ...
                                <td class="text-center" style="font-weight:bold"><?= ($x['pulang'] !== NULL )? $x['pulang'] : "<span class='text-warning'>-</span>" ?></td>
